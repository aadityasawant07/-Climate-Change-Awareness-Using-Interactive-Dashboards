  ...
  return (
    <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-emerald-500/40 max-w-md w-full mx-auto space-y-6 shadow-2xl">
      ...
      <div className="text-center space-y-1.5">
        ...
        <h2 className="text-2xl font-black text-white tracking-tight">Create EcoPulse Account</h2>
        <p className="text-xs text-slate-400">
          Save your climate assessment history, track progress, and pin favorite monitoring stations.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              minLength={6}
              className="w-full bg-climate-darker border border-climate-border rounded-xl pl-10 pr-4 py-2.5 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition-colors font-mono"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-xs sm:text-sm shadow-lg shadow-emerald-950/40 transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 mt-4"
        >
          {isLoading ? (
            <>
